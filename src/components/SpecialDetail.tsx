                    ...
                    >
                        <div
                            ...
                            <div className="font-body text-foreground/80 leading-relaxed space-y-4">
                                <p>
                                    Hoy celebro mucho más que un número. Celebro a la mujer inteligente, analítica,
                                    sensible y sarcástica que eres.
                                    Esa que cuida a todos antes que a sí misma, la del corazón noble que ha sido
                                    lastimado pero sigue amando con fuerza.
                                </p>
                                <p>
                                    Hace 5 años pasamos de ser amigos a ser todo. El tiempo contigo siempre pasa
                                    diferente — a veces vuela, a veces se detiene,
                                    pero siempre vale la pena. No somos una pareja perfecta, somos una pareja en
                                    construcción, y eso es lo más bonito que tenemos.
                                </p>
                                <p>
                                    Hemos pasado por momentos difíciles, por silencios que pesaban, por malentendidos y
                                    por perdón.
                                    Pero nada de eso fue despedida — fue aprender a amarnos mejor. Cada obstáculo nos
                                    hizo más fuertes,
                                    más conscientes, más elegidos.
                                </p>
                                <p>
                                    Tú eres mi refugio, mi guía, mi inspiración. No eres perfecta — eres real, y por eso
                                    eres perfecta para mí.
                                    Tu risa sana, tu mirada profunda, tu humor que nadie más entiende... todo eso me
                                    cautivó y no hay vuelta atrás.
                                </p>
                                <p>
                                    Sigo eligiéndote. Hoy, en calma, sin ruido, con respeto. Te elijo mejor que ayer.
                                    Porque este cumpleaños no celebra solo tu edad — celebra la mujer que eres, el amor
                                    que das
