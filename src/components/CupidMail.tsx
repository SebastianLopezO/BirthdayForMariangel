            ...
            <div className="max-w-lg mx-auto text-center relative">
                ...
                {!accepted ? (
                    ...
                    <div className="animate-bounce-in">
                        <div
                            className="inline-block px-10 py-8 rounded-3xl bg-background border-2 border-birthday-gold/30 shadow-lg max-w-md">
                            ...
                            <p className="text-muted-foreground font-body mt-2 leading-relaxed">
                                Pasamos por pausas, malentendidos y silencios. Pero no porque dejamos de querernos, sino
                                porque aprendimos a amar mejor. Cada obstáculo nos hizo más fuertes, más conscientes y
                                más elegidos. Aquí seguimos, con orgullo. 💕
                            </p>
                        </div>
                    </div>
                )}
