...
const DESTINATIONS: Destination[] = [
    {
        id: 1,
        emoji: "💫",
        name: "De amigos a todo",
        description: "Empezamos hablando como amigos, pero el corazón sabía que era algo más. De risas, de conversaciones eternas, nació esto.",
        x: 25,
        y: 35
    },
    {
        id: 2,
        emoji: "💬",
        name: "Las conversaciones infinitas",
        description: "De día a noche, sin parar. El tiempo contigo siempre pasa diferente — a veces vuela, a veces se detiene.",
        x: 55,
        y: 25
    },
    {
        id: 3,
        emoji: "🕊️",
        name: "Lo que superamos juntos",
        description: "Silencios, malentendidos, perdón mutuo. No fue ruptura, fue aprender a amar mejor. Y aquí seguimos, con orgullo.",
        x: 75,
        y: 45
    },
    {
        id: 4,
        emoji: "😂",
        name: "Tu humor que me sana",
        description: "Tu sarcasmo, tu humor bizarro, esas risas que sanan todo. No hay nadie como tú.",
        x: 40,
        y: 60
    },
    {
        id: 5,
        emoji: "💕",
        name: "5 años eligiéndonos",
        description: "No por costumbre, no por inercia. Porque queremos, porque crecemos, porque vale la pena.",
        x: 65,
        y: 70
    },
    {
        ...
        emoji: "🎂",
        name: "Cumpleaños #22",
        description: "Hoy celebro la mujer que eres, el amor que das y la historia que seguimos escribiendo juntos ∞",
        x: 20,
        y: 65
    },
];
