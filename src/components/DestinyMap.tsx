...
const HeartPin = ({
  ...
  >
    ...
    {/* Label on hover */}
    <div className="absolute left-1/2 -translate-x-1/2 -top-10 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:-top-12 whitespace-nowrap bg-card/90 backdrop-blur-sm border border-primary/30 rounded-lg px-3 py-1.5 text-xs font-body font-semibold text-primary pointer-events-none">
      {dest.name}
    </div>
  </div>
);
    ...
    <section className="relative z-20 py-20 px-4 bg-secondary/20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          {/* Map container */}
          <div className="relative w-full aspect-[16/9] rounded-2xl border border-primary/20 bg-card/30 backdrop-blur-sm overflow-hidden">
            {/* Map grid lines */}
            {[...Array(8)].map((_, i) => (
              <div
                key={`h-${i}`}
            ...
            {/* Abstract landmasses */}
            <div className="absolute w-[30%] h-[40%] top-[15%] left-[10%] rounded-[60%_40%_50%_70%] bg-primary/5 border border-primary/10" />
            <div className="absolute w-[25%] h-[35%] top-[20%] left-[45%] rounded-[40%_60%_30%_70%] bg-primary/5 border border-primary/10" />
            <div className="absolute w-[20%] h-[30%] top-[45%] left-[30%] rounded-[50%_50%_40%_60%] bg-primary/5 border border-primary/10" />
            <div className="absolute w-[15%] h-[25%] top-[50%] left-[65%] rounded-[45%_55%_60%_40%] bg-primary/5 border border-primary/10" />
            ...
            {/* Compass */}
            <div className="absolute bottom-3 right-3 w-10 h-10 rounded-full border border-primary/20 bg-card/40 backdrop-blur-sm flex items-center justify-center">
          ...
          >
            {activeDest && (
              <div className="text-center bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 animate-fade-in-up">
