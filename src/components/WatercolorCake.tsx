    ...
    <div className="relative w-full max-w-md mx-auto py-8">
      ...
      <svg viewBox="0 0 400 380" className="w-full h-auto relative z-10">
        ...
        {[90, 130, 170, 210, 250, 290].map((x, i) => (
          <ellipse key={`drip-b-${i}`} cx={x} cy={283 + (i % 2) * 4} rx="9" ry={10 + (i % 3) * 5} fill="hsl(0, 0%, 96%)" />
        ))}
        ...
        {[110, 150, 195, 240, 280].map((x, i) => (
          <ellipse key={`drip-m-${i}`} cx={x} cy={211 + (i % 2) * 3} rx="8" ry={8 + (i % 3) * 4} fill="hsl(330, 50%, 80%)" />
        ))}
        ...
        {[135, 170, 210, 250].map((x, i) => (
          <ellipse key={`drip-t-${i}`} cx={x} cy={151 + (i % 2) * 3} rx="8" ry={8 + (i % 3) * 4} fill="hsl(0, 0%, 97%)" />
        ))}
        ...
        {[140, 165, 195, 225, 255].map((x, i) => (
          <g key={`cherry-${i}`}>
            ...
            <path d={`M${x},125 Q${x + 3},115 ${x + 8},112`} stroke="hsl(120, 40%, 35%)" strokeWidth="1.5" fill="none" />
          </g>
        ))}
