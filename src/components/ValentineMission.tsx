    ...
    return (
        <section className="relative z-20 py-20 px-4 overflow-hidden bg-birthday-gold/10">
            <div className="max-w-md mx-auto text-center relative">
                {/* Decorative balloons */}
                <div className="absolute -top-4 left-4 text-3xl rotate-[-15deg] opacity-40 animate-balloon-float">🎈
                </div>
                <div className="absolute -top-2 right-6 text-2xl rotate-[10deg] opacity-30 animate-balloon-float"
                ...
                {answer === null ? (
                    ...
                    <div className="animate-bounce-in">
                        <div
                            className="inline-block px-8 py-6 rounded-2xl bg-background border-2 border-birthday-gold/30 shadow-lg">
