      ...
      <section className="relative z-20 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-xl sm:text-2xl text-foreground/80 font-elegant italic max-w-lg mx-auto">
            Llegaste a mi vida sin avisar, y desde entonces mi corazón te reconoce siempre como la primera vez ♥
          </p>
        </div>
      ...
      <section className="relative z-20 py-16 px-4">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <MessageCard title="Tu sonrisa de niña" message="Esa sonrisa radiante que me hace feliz desde la distancia. Tus mejillas siempre rojas, tus ojos oscuros que brillan en el sol... no me canso de admirarte." delay={0} variant="default" />
            <MessageCard title="Lo que me enseñaste" message="En ti descubrí una mujer que compartía su conocimiento de sol a sol, que me habló sin escrúpulos y me dio confianza para ser quien soy. Contigo aprendo de la mejor manera: con amor." delay={200} variant="accent" />
            <MessageCard title="Tu forma bizarra de amar" message="Tú no amas con palabras convencionales, sino de maneras más bonitas y bizarras que no solo me enamoran, sino que me llenan de risa y alegría. Así eres tú, única." delay={400} variant="elegant" />
            <MessageCard title="17 de diciembre de 2020" message="Ese día mi vida cambió para siempre. Hubo dificultades antes de estar juntos, pero cada obstáculo valió la pena. Cada beso, cada abrazo, cada momento lo llevo clavado en el alma." delay={600} variant="default" />
          </div>
        </div>
      </section>
