        ...
        <div className="relative min-h-screen bg-background">
            ...
            <section className="relative z-20 py-16 px-4 bg-birthday-cream">
                <div className="max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <MessageCard title="Tu amor que elige quedarse"
                                     message="No somos perfectos, pero somos reales. Hemos aprendido a amarnos mejor, a callar cuando hay que callar y a hablar cuando el silencio pesa. 5 años eligiéndonos, y aquí seguimos."
                                     delay={0} variant="default"/>
                        <MessageCard title="Tu forma de amar sin ruido"
                                     message="Amas con acciones, con presencia, con gestos que valen más que mil palabras. Tu humor bizarro, tu sarcasmo, tu inteligencia... todo eso es tu forma de decir 'te quiero'."
                                     delay={200} variant="accent"/>
                        <MessageCard title="Lo que hemos superado juntos"
                                     message="Momentos difíciles, silencios, malentendidos, perdón mutuo. Cada obstáculo nos hizo más fuertes. No celebro solo tus 22, celebro la mujer que eres después de todo lo vivido."
                                     delay={400} variant="elegant"/>
                        <MessageCard title="Lo que sigo eligiendo"
                                     message="Elegirte hoy, en calma, sin ruido, con respeto. Elegirte mejor que ayer. Porque crecer contigo vale cada segundo, cada risa y cada lágrima que compartimos."
            ...
            <section className="relative z-20 py-16 px-4 bg-background">
                <div className="max-w-md mx-auto text-center">
                    ...
                    <p className="text-muted-foreground font-body mb-6">22 velas, una por cada año que el mundo es mejor
                        contigo</p>
                    <HeartTree/>
                </div>
            </section>
